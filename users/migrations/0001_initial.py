    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('ADMIN', 'Administrador'), ('FACILITATOR', 'Facilitador'), ('DIRECTOR', 'Directivo'), ('PARTNER', 'Socio')], default='PARTNER', max_length=20)),
                ('document_type', models.CharField(choices=[('DNI', 'DNI'), ('CE', 'CE'), ('NONE', 'None')], default='NONE', max_length=10)),
